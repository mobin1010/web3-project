...
const TransactionsCard =({addressTo,addressFrom,amount,message,url,timestamp,keyword}) =>
        ...
        flex-col p-3 rounded-md hover:shadow-2xl">
            <div className="flex flex-col items-center w-full mt-3">
                <div className="display-flex justify-start w-full mb-6 p-2">
                   <a href={`http://mumbai.polygonscan.com/${addressFrom} `} target="_blank" rel=" noreferrer">
                    <p className="text-white text-base">From:{shortenAddress(addressFrom)}</p>
                   </a>
                   <a href={`http://mumbai.polygonscan.com/${addressTo} `} target="_blank" rel=" noreferrer">
